...
target = torch.randn(B, T)         # last dim भूल गए
diff = logits - target              # quietly broadcast to (B, T, V) — bug
```

Doubt में हमेशा shapes print करो।
...
ये **एकमात्र loss** है जो language models train करने में use होता है।
