...
| 17 | [Production Inference](./17-production-inference.md) | 10,000 requests serve करना: vLLM/SGLang, FP8, prefix cache, speculative, autoscaling। |
...
2. **00-03 foundations हैं। 04-13 model build करते हैं। 14-15 train और debug करते हैं। 16-17 frontier models और real users तक deployment।**
