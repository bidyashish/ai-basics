...
| 19 | [Evaluation](./19-evaluation.md) | Capability benchmarks, LLM-as-judge, golden sets, agent evals (SWE-bench, OSWorld), eval-driven development। |
| 20 | [Fine-tuning Recipes](./20-fine-tuning-recipes.md) | Decision tree, LoRA/QLoRA/DoRA, SFT/DPO/GRPO recipes, 150 lines में end-to-end Qwen 3 fine-tune। |
| 21 | [Embeddings & RAG](./21-embeddings-and-rag.md) | Embedding models, vector DBs, hybrid search, reranking, chunking, agentic RAG, 80 lines में complete RAG। |
| 22 | [Multimodal Models](./22-multimodal.md) | VLM architectures, SigLIP-2, native multi-resolution, audio (Whisper, Realtime), VLMs के लिए QLoRA, hallucination evals। |
| 23 | [Safety & Alignment](./23-safety-and-alignment.md) | Four kinds of safety, prompt injection, content moderation, PyRIT से red-teaming, compliance (EU AI Act, GDPR)। |
...
| 25 | [Model Releases & Debugging](./25-model-releases-and-debugging.md) | Release ladder (major/minor/point/patch), continual vs fresh pretrain, per role tool stack, hooks, TransformerLens, logit lens, ablation, activation patching, SAEs से model के अंदर देखना। |
| 26 | [Mechanistic Debugging in Practice](./26-mechanistic-debugging.md) | Hands-on: safetensors surgery, circuit tracing step-by-step, steering vectors से sycophancy fix, SAE feature suppression, neurons के अंदर breakpoints, chart visualizations, real before/after measurements। |
| 27 | [Useful, Not Benchmaxxed](./27-useful-not-benchmaxxed.md) | **सबसे important chapter।** Goodhart's Law, useful का actual मतलब, leaderboards नहीं users के लिए evaluate और train कैसे करें, anti-pattern catalog, और products के case studies जो benchmarks ignore करके जीतते हैं। |
...
2. **00-03 foundations। 04-13 model build। 14-15 train। 16-17 deploy। 18 product wrap। 19-23 operational maturity। 24 Gemma 4 reference। 25-26 release engineering और debugging। एक भी benchmark number publish करने से पहले 27 पढ़ो** — ये leaderboard champions नहीं *useful* models बनाने का chapter है, philosophy जो decide करता है कि बाकी work mattered या नहीं।**
