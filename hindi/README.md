...
2. **00-03 foundations हैं। 04-13 model build करते हैं। 14-15 train करते हैं। 16-17 deploy करते हैं। 18 product में wrap करता है। 19-23 operational maturity layer है। 24 एक focused Gemma 4 reference है। 25 release-engineering और mechanistic-debugging chapter है — versions कैसे ship होती हैं, हर role के लिए कौन सा tool, और जब चीज़ें ग़लत जाएं तो model के अंदर कैसे देखें।**
