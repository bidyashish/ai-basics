...
| 26 | [Mechanistic Debugging in Practice](./26-mechanistic-debugging.md) | Hands-on: safetensors surgery, circuit tracing step-by-step, sycophancy fix with steering vectors, SAE feature suppression, breakpoints inside neurons, chart visualizations, real before/after measurements. |
| 27 | [Useful, Not Benchmaxxed](./27-useful-not-benchmaxxed.md) | **The most important chapter.** Goodhart's Law, what useful actually means, how to evaluate and train for users not leaderboards, the anti-pattern catalog, and case studies of products that win by ignoring benchmarks. |
